...
Assert.assertTrue(response instanceof JSONObject);JSONObject object346860 = (JSONObject) responseAssert.assertTrue(object346860.containsKey(id));Assert.assertTrue(object346860_2 instanceof Integer);
